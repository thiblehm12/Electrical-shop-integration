...
<head>
    ...
    <link rel="stylesheet" href="css/datas4.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="warehouses.php">Warehouses</a></li>
    ...
    <div class="datas-cat">
        ...
        $sql = "SELECT warehouse.Address, country.Country_Name, city.City_Name 
                FROM ((warehouse 
                INNER JOIN country ON warehouse.CountryID = country.CountryID) 
                INNER JOIN city ON warehouse.CityID = city.CityID)";
