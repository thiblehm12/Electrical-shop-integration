...
<head>
    ...
    <link rel="stylesheet" href="css/datas1.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="items.php">Items</a></li>
    ...
    <div class="datas-cat">
        ...
        $sql = "SELECT item.Item_Name, customer.First_Name, customer.Last_Name, supplier.Company, item.Discount, item.Unit_Price, item.Units_In_Stock, item.Quantity, employee.First_Name, employee.Last_Name, warehouse.Address, category.Category_Name 
                FROM (((((item 
                INNER JOIN customer ON item.CustomerID = customer.CustomerID) 
                INNER JOIN supplier ON item.SupplierID = supplier.SupplierID) 
                INNER JOIN employee ON item.EmployeeID = employee.EmployeeID) 
                INNER JOIN warehouse ON item.WarehouseID = warehouse.WarehouseID) 
        ...
        echo '<table>';
            echo '<tr>';
                    ...
                    echo '<th>Cust_Surname</th>';
                    echo '<th>Company</th>';
                    echo '<th>Discount</th>';
                    echo '<th>Unit_Price</th>';  
                    echo '<th>Units_In_Stock</th>';  
                    echo '<th>Quantity</th>';  
                    echo '<th>Empl_Name</th>'; 
                    echo '<th>Empl_Surname</th>';  
                    echo '<th>Warehouse_Address</th>'; 
