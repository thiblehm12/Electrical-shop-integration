...
<head>
    ...
    <link rel="stylesheet" href="css/datas3.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="customers.php">Customers</a></li>
    ...
    <div class="datas-cat">
        ...
        $sql = "SELECT customer.First_Name, customer.Last_Name, customer.Phone_Number, country.Country_Name, city.City_Name, customer.Payment 
                FROM ((customer 
