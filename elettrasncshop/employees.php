...
<head>
    ...
    <link rel="stylesheet" href="css/datas8.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="employees.php">Employees</a></li> 
                </ul>
    ...
    <div class="datas-cat">    
        ...
        $sql = "SELECT First_Name, Last_Name, Birthday_Date, Phone_Number, Gender, Role    
                FROM employee";
